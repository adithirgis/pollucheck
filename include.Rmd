...
*A dummy dataset is loaded, so, without uploading the data keep clicking buttons to generate plots in this app.*
...
*The data will be as it is except that it will remove fill values from the data.*
...
*The data availability plot shows the available daily data for each parameter.*
...
*Daily mean and monthly mean is used to perform Trend Analysis by Mann-Kendall.*
...
**openair details -**  
*We did not build openair. We use functions from openair to plot. The openair package usage and other details can be found [here](https://github.com/davidcarslaw/openair).*
