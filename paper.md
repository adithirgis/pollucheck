...
![](inst/shiny/WWW/figure1a.png){ width=80% }

![Hourly time series of raw (top panel) and cleaned (bottom panel) PM~2.5~.](inst/shiny/WWW/figure1b.png){ width=80% }
...
![](inst/shiny/WWW/figure2a.png){ width=80% }

![Box plots depicting the monthly variations in hourly PM~2.5~.](inst/shiny/WWW/figure2b.png){ width=80% }
...
![](inst/shiny/WWW/figure3a.png){ width=80% }

![Diurnal variations in PM~2.5~.](inst/shiny/WWW/figure3b.png){ width=80% }
...
![Linear regression analysis.](inst/shiny/WWW/figure4.png){ width=80% }
...
![PM~2.5~ periodicity analysis based on wavelet transform.](inst/shiny/WWW/figure5.png){ width=80% }
